...
| D18 | Bank rate (§2.4) | "default 12.0%, configurable" | Per-**application** input, defaulting to 12.0 | The workbook's `Raw` tab varies it 8.1–13.6 across rows. Pinning it globally would misprice historical replays | `DELIBERATE` |
